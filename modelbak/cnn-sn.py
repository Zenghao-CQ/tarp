...
def draw_fig(list,name,epoch):
    ...
    if name=="loss":
        ...
        plt.grid()
        plt.savefig("../lossAndaccCNN/Train_loss.png")
        plt.show()
    elif name =="acc":
        plt.cla()
        ...
        plt.grid()
        plt.savefig("../lossAndaccCNN/Train_accuracy.png")
        plt.show()
    elif name =="val":
        plt.cla()
        ...
        plt.grid()
        plt.savefig("../lossAndaccCNN/Vlid_accuracy.png")
        plt.show()
...
def eval(glist, model):
    ...
    for g in glist:
        ...
        features = th.cat([features,g.ndata["N"].to(th.float32)],dim=1)
        # normalize
