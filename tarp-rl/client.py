...
class Environment():
    ...
    def get_state(self):
        ...
        return g,d,tp,SLO_score,res_use
    ...
    def update_env(self):
        ...
        if load<15:
            ...
            self.load=80
        g,d,tp = get_sub(self.load, self.prof)
        self.g=g
        self.d=d
        self.tp=tp
    ...
    def perform_action(self, prof):
        ...
        self.update_env()
        return g,reward,d,tp,SLO_score,res_use #state_graph, reawrd, delay, SLO, resource usage
