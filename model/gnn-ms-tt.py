...
#         plt.grid()
#         plt.savefig("../lossAndacc-trans/Train_loss.png")
#         plt.show()
#     elif name =="acc":
#         plt.cla()
...
#         plt.grid()
#         plt.savefig("../lossAndacc-trans/Train_accuracy.png")
#         plt.show()
#     elif name =="val":
#         plt.cla()
...
#         plt.grid()
#         plt.savefig("../lossAndacc-trans/Vlid_accuracy.png")
#         plt.show()
...
val_list,l=load_graphs('../dgl_graph/40.g')
random.shuffle(val_list)
random.shuffle(glist)

# glist,val_list=val_list,glist

data_loader = DataLoader(glist, batch_size=32, shuffle=True, collate_fn=collate)
...
if __name__ == "__main__":
    th.manual_seed(3407)
    train(glist,val_list, model, num_epoch=150, learning_rate=0.002)
    # g=glist[100]
    # print(g.ndata["N"])
    # print(g.ndata["label"])
    # print(g.edata["E"])